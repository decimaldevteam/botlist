    ...
    return (
        <div className="review-card">
            ...
            <div className="review">
                <span>
                    <img
                        src={`https://cdn.discordapp.com/avatars/${review.user.id}/${review.user.avatar}.webp`}
                        alt="Avatar"
                    />
                </span>
                    ...
                    <span className="r-username">
                        ...
                        {review.user.id === id ? (
                            <a
                                onClick={() => {
                                    fetch(
                                        `https://botlistapi.decimaldev.xyz/review/${parent.props.id}/delete`,
                                        {
                                            headers: {
                                                token: window.token,
                                                id: review.time,
                                        ...
                                        .then((body) => {
                                            if (body.message === "OK")
                                                return parent.makeReviews();
                                            else if (body.message === "expired")
